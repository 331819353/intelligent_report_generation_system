    ...
    <main className="login-page">
      ...
      <section className="login-panel">
        <form onSubmit={submit}>
          ...
          <p className="login-form-intro">{mode === 'register' ? '新账号自动绑定租户默认领域和最小权限角色。' : '使用组织账号进入你的数据配置空间。'}</p>
          ...
          <p className="form-hint">{mode === 'register' ? '注册后管理员可在权限设定中调整你的角色。' : '登录即代表你同意遵守所属租户的数据安全策略。'}</p>
        </form>
      </section>
    </main>
  )
