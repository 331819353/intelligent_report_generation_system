...
const commonActions = ['VIEW', 'EDIT', 'PUBLISH', 'VERSIONS', 'PERMISSIONS', 'ARCHIVE'] as const
...
export const reportAssetFixtures: ReportAsset[] = [
  {
    ...
    allowedActions: [...commonActions], previewKind: 'operations',
  },
  {
    ...
    allowedActions: ['VIEW', 'VERSIONS'], previewKind: 'sales',
  },
  {
    ...
    allowedActions: ['EDIT', 'PUBLISH', 'PERMISSIONS', 'ARCHIVE'], previewKind: 'quality',
  },
  {
    ...
    allowedActions: ['VIEW', 'EDIT', 'VERSIONS'], previewKind: 'inventory',
  },
  {
    ...
    allowedActions: ['VERSIONS', 'PERMISSIONS', 'RESTORE'], previewKind: 'channel',
  },
  {
    ...
    allowedActions: ['VIEW', 'VERSIONS'], previewKind: 'cashflow',
  },
]
