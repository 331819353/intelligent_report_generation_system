-- Reconcile Report V2 installations that applied 000234/000237/000238 before
-- their definitions were hardened. Keep this migration even though fresh
-- databases also receive the corrected definitions in the original files.
