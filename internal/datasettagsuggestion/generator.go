...
请依据数据集说明、字段语义、DAG/粒度、技术元数据和精确上游语义摘要选择所有有充分证据的标签，重点覆盖 TABLE_FUNCTION、USAGE_SCOPE、DATA_GRAIN、JOIN_ROLE、BUSINESS_ENTITY。
...
func suggestedCategory(value string) bool {
	switch value {
	case "BUSINESS_ENTITY", "TABLE_FUNCTION",
